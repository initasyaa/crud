                                        ...
                                        @foreach ($data as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a data-toggle="modal" data-target="#modal-delete{{ $d->id }}" href="" class="btn btn-danger"><i class="fas fa-trash-alt"></i>Hapus</a>
                                            </tr>
                                                ...
                                                <div class="modal-dialog">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                      <p>Apakah kamu yakin ingin hapus menhapus produk <b>{{ $d->name }}</b>?</p>
                                                    </div>
                                                    <div class="modal-footer justify-content-between">
                                                        <form action="{{ route('user.destroy', ['id' =>$d->id]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
